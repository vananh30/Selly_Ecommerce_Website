...
var valStore = document.getElementById("store");
...
email.addEventListener('keyup', verfiedEmail);
fname.addEventListener('keyup', verfiedFname);
lname.addEventListener('keyup', verfiedLname);
phone.addEventListener('keyup', verifiedPhone);
address.addEventListener('keyup', verifiedAddress);
city.addEventListener('keyup', verifiedCity);
zipcode.addEventListener('keyup', verifiedZipcode);
password.addEventListener('keyup', verifiedPassword);
repassword.addEventListener('keyup', verifiedRepassword);
business_name.addEventListener('keyup', verifiedBusinessName);
store_name.addEventListener('keyup', verifiedStoreName);
...
function validated() {
    ...
    // check validation of store owner
    if(valStore.checked){
